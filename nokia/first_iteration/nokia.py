...
match menu_choice:
    ...
    case 6:
        ...
        match choice:
            case 1:
                print("Call settings (submenu not fully implemented)")
            case 2:
                print("Phone settings (submenu not fully implemented)")
            case 3:
                print("Security settings (submenu not fully implemented)")
            case 4:
